...
//            operationtime.text = "开" + s01up.first + "<br>收" + s01up.last;
...
//            operationtime.text = "开" + s01down.first + "<br>收" + s01down.last;
...
//            operationtime.text = "开" + s02up.first + "<br>收" + s02up.last;
...
//            operationtime.text = "开" + s02down.first + "<br>收" + s02down.last;
...
//            operationtime.text = "开" + s03up.first + "<br>收" + s03up.last;
...
//            operationtime.text = "开" + s03down.first + "<br>收" + s03down.last;
...
//            operationtime.text = "开" + s04aup.first + "<br>收" + s04aup.last;
...
//            operationtime.text = "开" + s04adown.first + "<br>收" + s04adown.last;
...
//            operationtime.text = "开" + s04bup.first + "<br>收" + s04bup.last;
...
//            operationtime.text = "开" + s04bdown.first + "<br>收" + s04bdown.last;
...
//            operationtime.text = "开" + s05aup.first + "<br>收" + s05aup.last;
...
//            operationtime.text = "开" + s05adown.first + "<br>收" + s05adown.last;
...
//            operationtime.text = "开" + s05bup.first + "<br>收" + s05bup.last;
...
//            operationtime.text = "开" + s05bdown.first + "<br>收" + s05bdown.last;
//            silicalistview.model = s05bdown;
//        }
        if (rt === "s06" && bound === "up") {
            route.text = s06up.route;
            terminal1.text = s06up.start;
            terminal2.text = "往 " + s06up.end;
            operationtime.text = "开" + s06up.first + "<br>收" + s06up.last;
            info.text = s06up.info
            silicalistview.model = s06up;
        }
        else if (rt === "s06" && bound === "down") {
            route.text = s06down.route;
            terminal1.text = s06down.start;
            terminal2.text = "往 " + s06down.end;
            operationtime.text = "开" + s06down.first + "<br>收" + s06down.last;
            info.text = s06down.info
            silicalistview.model = s06down;
        }
//        else if (rt === "s06b" && bound === "up") {
//            route.text = s06bup.route;
//            terminal1.text = s06bup.start;
//            terminal2.text = "往 " + s06bup.end;
//            operationtime.text = "开" + s06bup.first + "<br>收" + s06bup.last;
...
//            operationtime.text = "开" + s06bdown.first + "<br>收" + s06bdown.last;
...
//            operationtime.text = "开" + s07up.first + "<br>收" + s07up.last;
...
//            operationtime.text = "开" + s07down.first + "<br>收" + s07down.last;
...
//            operationtime.text = "开" + s08up.first + "<br>收" + s08up.last;
...
//            operationtime.text = "开" + s08down.first + "<br>收" + s08down.last;
...
//        }
            ...
            operationtime.text = "开" + s09up.first + "<br>收" + s09up.last;
            info.text = s09up.info
            ...
            operationtime.text = "开" + s09down.first + "<br>收" + s09down.last;
            info.text = s09down.info
            ...
            operationtime.text = "开" + s10up.first + "<br>收" + s10up.last;
            info.text = s10up.info
            ...
            operationtime.text = "开" + s10down.first + "<br>收" + s10down.last;
            info.text = s10down.info
...
//            operationtime.text = "开" + s11up.first + "<br>收" + s11up.last;
...
//            operationtime.text = "开" + s11down.first + "<br>收" + s11down.last;
...
//            operationtime.text = "开" + s12up.first + "<br>收" + s12up.last;
...
//            operationtime.text = "开" + s12down.first + "<br>收" + s12down.last;
...
//            operationtime.text = "开" + s13aup.first + "<br>收" + s13aup.last;
...
//            operationtime.text = "开" + s13adown.first + "<br>收" + s13adown.last;
...
//            operationtime.text = "开" + s13bup.first + "<br>收" + s13bup.last;
...
//            operationtime.text = "开" + s13bdown.first + "<br>收" + s13bdown.last;
...
//            operationtime.text = "开" + s13cup.first + "<br>收" + s13cup.last;
...
//            operationtime.text = "开" + s13cdown.first + "<br>收" + s13cdown.last;
...
//            operationtime.text = "开" + s14up.first + "<br>收" + s14up.last;
...
//            operationtime.text = "开" + s14down.first + "<br>收" + s14down.last;
...
//        }
    ...
    Column {
        ...
        Rectangle {
            ...
            width: parent.width
            height: route.height + wharftag.height + info.height + Theme.paddingLarge + Theme.paddingMedium + Theme.paddingSmall
            ...
            Label {
                ...
                //text: "头" + routeid.first + "<br>收" + routeid.last
            }
